...
namespace SimplePhoneBook.Data.Migrations
{
    ...
    [Migration("20210128052051_UpdatedEnitityModifiedDate")]
    partial class UpdatedEnitityModifiedDate
    {
            ...
            modelBuilder.Entity("SimplePhoneBook.Data.Entites.PhoneNumberType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ModifiedDate = new DateTime(2021, 1, 28, 7, 20, 51, 68, DateTimeKind.Local).AddTicks(6000),
                            Name = "Mobile"
                        },
                        new
                        {
                            Id = 2,
                            ModifiedDate = new DateTime(2021, 1, 28, 7, 20, 51, 70, DateTimeKind.Local).AddTicks(1409),
                            Name = "Home"
                        },
                        new
                        {
                            Id = 3,
                            ModifiedDate = new DateTime(2021, 1, 28, 7, 20, 51, 70, DateTimeKind.Local).AddTicks(1430),
                            Name = "Work"
                        },
                        new
                        {
                            Id = 4,
                            ModifiedDate = new DateTime(2021, 1, 28, 7, 20, 51, 70, DateTimeKind.Local).AddTicks(1434),
                            Name = "Other"
                        });
                });
